              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="form-group">
                    ...
                    <input type="email" name="contact_number" id="contact-number" class="form-control">
                  </div>
                </div>
                <div class="col-lg-4">
                  <div class="form-group">
...
<?php
 ...
 if(isset($_POST['submit'])){
    ...
    $sql="insert into appointment_list(first_name,last_name,dob,location,contact_number,age,post_code,cnic_number,select_vaccine,select_hospital) values('$first_name','$last_name','$dob','$location','$contact_number','$age','$post_code','$cnic_number','$select_vaccine','$select_hospital')";
    $result=mysqli_query($conn,$sql);
